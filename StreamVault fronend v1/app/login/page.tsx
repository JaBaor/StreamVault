    ...
    <div className="mx-auto w-full max-w-md px-4 py-12 sm:py-16">
      ...
      <div className="mt-4">
        <button
          ...
          className="flex w-full items-center justify-center gap-2 rounded-lg border border-zinc-700 bg-zinc-900 px-4 py-2.5 text-sm text-zinc-300 hover:bg-zinc-800"
        >
